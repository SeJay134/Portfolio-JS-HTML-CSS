...
- [ ] Phase 1.4 — Safe contact flow acceptance
- [ ] Phase 2.1 — Design tokens and themes acceptance
- [ ] Phase 2.2 — Accessible left drawer acceptance
...
- [ ] Phase 5 — React migration and frontend tooling acceptance
- [ ] Phase 6 — Optional Three.js scene acceptance
- [ ] Phase 7.1 — Final browser, accessibility, and performance checks
- [ ] Phase 7.2 — Real-device checks and production release
